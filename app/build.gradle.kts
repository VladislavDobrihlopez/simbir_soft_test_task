...
android {
    namespace = "com.dobrihlopez.simbir_soft_test_task"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.dobrihlopez.simbir_soft_test_task"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    ksp {
        val folderName = "db_schemas"
        arg("room.schemaLocation", "$projectDir/$folderName")
    }
}
